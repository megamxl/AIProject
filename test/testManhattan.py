...
class ManhattanTests(unittest.TestCase):
    def test_distanceCalc(self):
        distance0 = Manhattan.Manhattan.calc([[0, 1, 2], [3, 4, 5], [6, 7, 8]])
        distance20 = Manhattan.Manhattan.calc([[8, 7, 6], [5, 4, 3], [2, 1, 0]])
        distance19 = Manhattan.Manhattan.calc([[7, 3, 4], [5, 6, 0], [2, 8, 1]])
