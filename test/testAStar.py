...
class AStarTests(unittest.TestCase):
    ...
    def test_move_tile(self):
        new_puzzle = Puzzle()
        new_puzzle.grid = [[7, 3, 4], [5, 6, 0], [2, 8, 1]]
        self.assertEqual(True, AStar.compare([[7, 3, 4], [5, 0, 6], [2, 8, 1]], AStar.moveTile(new_puzzle.grid, (0, -1))))
        self.assertEqual(True, AStar.compare([[7, 3, 4], [0, 5, 6], [2, 8, 1]], AStar.moveTile(new_puzzle.grid, (0, -1))))
        self.assertEqual(True, AStar.compare([[7, 3, 4], [2, 5, 6], [0, 8, 1]], AStar.moveTile(new_puzzle.grid, (1, 0))))
